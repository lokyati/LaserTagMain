...
<div id="slider">
	<transition-group tag="div" :name="transitionName" class="slides-group">
      ...
      <reservationcard :card="Reservations" :m="m" :n="n" v-on:selectReservation="selectReservation($event)"></reservationcard>
  	</div>
	</transition-group>
...
export default {
  ...
  methods: {
    slide(dir) {
      ...
      var len = this.Reservations.length;
    ...
    selectReservation(id){
      this.ID = id;
      this.$emit('selectReservation',this.ID);
    }
  },
  components: {
  ...
  computed: {
    articleGroups() {
      return Array.from(Array(Math.ceil(this.Reservations.length / this.itemsPerRow)).keys())
    },
